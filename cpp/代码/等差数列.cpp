...
void Add(int l,int r,int L,int R,int a,int b,int cur){
	//比较一下a,b和AA[cur]BB[cur]，哪个能控制区间[l,r]
	//假如a,b比较厉害，就用a,b交换AA[cur],BB[cur]， 
	//并把另一个下传，调用Add(mid+1,r,L,R,a,b,cur<<1|1)或者Add(l,mid, L,R,a,b,cur<<1)
}
